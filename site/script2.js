...
// ===== FAKE WPSCAN RANDOMIZED - TARGET: VORTEX INDUSTRIES =====
const wpscanLines = [
    { text: '', delay: 0 },
    { text: 'wpscan --url https://vortex-industries.io/ --force --enumerate u1-20,vp,vt', delay: 0, cls: 'highlight' },
    ...
    { text: '                        Version 3.8.42', delay: 860, cls: 'dim' },
    { text: '', delay: 900 },
    ...
    { text: '', delay: 1050 },
    { text: '[i] Target: https://vortex-industries.io/ [104.26.12.188]', delay: 1100, cls: 'highlight' },
    { text: '[i] Server: Nginx/1.24.0 (Ubuntu)', delay: 1200, cls: 'dim' },
    { text: '[i] Updating the Database ... Done.', delay: 1500 },
    { text: '', delay: 1600 },
    { text: '[+] Headers', delay: 1700, cls: 'highlight' },
    { text: ' |  - x-content-type-options: nosniff', delay: 1800, cls: 'dim' },
    { text: ' |  - x-frame-options: SAMEORIGIN', delay: 1880, cls: 'dim' },
    { text: ' |  - x-vortex-cache: MISS', delay: 1960, cls: 'dim' },
    { text: ' | Confidence: 100%', delay: 2050 },
    { text: '', delay: 2100 },
    { text: '[+] XML-RPC seems to be enabled: https://vortex-industries.io/xmlrpc.php', delay: 2200, cls: 'purple' },
    { text: ' | Found By: Link Tag (Passive Detection)', delay: 2300, cls: 'dim' },
    { text: ' | Confidence: 100%', delay: 2400 },
    { text: '', delay: 2500 },
    { text: '[+] WordPress version 6.5.2 identified (Insecure).', delay: 2600, cls: 'highlight' },
    { text: ' | Found By: Advanced Fingerprinting', delay: 2700, cls: 'dim' },
    { text: '', delay: 2800 },
    { text: '[+] WordPress theme in use: vortex-black-pro', delay: 2900, cls: 'highlight' },
    { text: ' | Version: 2.1.4 (Latest is 2.2.0)', delay: 3000, cls: 'dim' },
    { text: '', delay: 3100 },
    { text: '[+] Enumerating Vulnerable Plugins...', delay: 3200, cls: 'highlight' },
    { text: ' [!] Title: WooCommerce 8.0.x - Unauthenticated Reflected XSS', delay: 3500, cls: 'purple' },
    { text: '  |  Fixed in: 8.0.3', delay: 3600, cls: 'dim' },
    { text: ' [!] Title: Contact Form 7 < 5.8 - Remote Code Execution (RCE)', delay: 4000, cls: 'purple' },
    { text: '  |  Fixed in: 5.8.1', delay: 4100, cls: 'dim' },
    { text: '', delay: 4200 },
    { text: '[+] Enumerating Users...', delay: 4300, cls: 'highlight' },
    { text: ' | Found: sysadmin (ID: 1)', delay: 4500 },
    { text: ' | Found: d.vortex_staff (ID: 12)', delay: 4700 },
    { text: ' | Found: support_bot (ID: 44)', delay: 4900 },
    { text: '', delay: 5000 },
    { text: '[+] External WP-Cron enabled: https://vortex-industries.io/wp-cron.php', delay: 5100, cls: 'highlight' },
    { text: '', delay: 5200 },
    { text: '[+] Finished: Mon Feb 23 15:02:44 2026', delay: 5500, cls: 'purple' },
    { text: '[+] Requests Done: 642', delay: 5600, cls: 'highlight' },
    { text: '[+] Data Sent: 204.11 KB', delay: 5700, cls: 'dim' },
    { text: '[+] Data Received: 89.24 MB', delay: 5800, cls: 'dim' },
    { text: '[+] Memory used: 312.44 MB', delay: 5900, cls: 'dim' },
    { text: '[+] Elapsed time: 00:00:24', delay: 6000, cls: 'highlight' },
    { text: '', delay: 6100 },
];
